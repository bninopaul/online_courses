...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        time = 0
        while len(room.clean_tiles)<min_coverage*room.numtiles:
            for k in robots:
...
#
#       (... your call here ...)
showPlot1("Time Needed to Clean the Room with varying Number of Robots: StandardRobot vs RandomWalkRobot", "Aspect Ratio: width/height", "Mean Number of Time Steps")
#
...
#
#       (... your call here ...)
showPlot2("Time Needed to Clean the Room with varying Room Sizes: StandardRobot vs RandomWalkRobot", "Number of Robots", "Mean Number of Time Steps")
#
