...
class FeatureFactory:
    ...
    """
    def __init__(self):
        self.names_ = collections.defaultdict(lambda:0)
	...
	""" TODO: Add your features here """
        #namepattern = r''' #^[A-Z]([A-Za-z]+)?$'''
        #if re.match(namepattern, currentWord, re.VERBOSE) is not None:
        ...
        #if prevWord[0].isupper() and previousLabel=="O" and  prevWord in titles:
        #    features.append("title=True")
        #if currentWord[-1]=="."and currentWord[0].isupper()and previousLabel=="O":
        #    features.append("abbr=True")
        #if currentWord[0].isupper() and prevWord[0].isupper() and prevWord[-1]=="." and previousLabel=="PERSON":
